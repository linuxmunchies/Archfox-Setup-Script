...
setup_multimedia() {
  ...
  flatpak install dev.vencord.Vesktop com.spotify.Client com.mastermindzh.tidal-hifi com.github.iwalton3.jellyfin-media-player org.kde.gwenview com.obsproject.Studio org.nickvision.tubeconverter
